        ...
        <div class="container"><a class="navbar-brand" href="#page-top">Brand</a><button data-bs-toggle="collapse" data-bs-target="#navbarResponsive" class="navbar-toggler navbar-toggler-right" type="button" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><i class="fa fa-align-justify"></i></button>
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link" href="#about">Houses</a></li>
                    <li class="nav-item"><a class="nav-link" href="#services">Lands</a></li>
                    <li class="nav-item"><a class="nav-link" href="#portfolio">Apartments</a></li>
                    <li class="nav-item"><a class="nav-link" href="#contact">Building</a></li>
                </ul>
            </div>
        </div>
    </nav>
        ...
        <div class="container my-auto">
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <h1 class="text-uppercase"><strong>REAL ESTATE MANAGEMENT&nbsp;</strong></h1>
                    <hr>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col offset-lg-8 text-center mx-auto">
                    ...
                    <hr class="light my-4">
                    <p class="text-faded mb-4">Looking for a home, land (property) get in Touch with Us!</p><a class="btn btn-light btn-xl" role="button" href="#services">Get Started!</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3 text-center">
                    <div class="mx-auto service-box mt-5"><i class="fa fa-diamond fa-4x text-primary mb-3 sr-icons" data-aos="zoom-in" data-aos-duration="200" data-aos-once="true"></i>
                        ...
                        <p class="text-muted mb-0">Single Unit</p>
                        <p class="text-muted mb-0">Larger Building</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 text-center">
                    <div class="mx-auto service-box mt-5"><i class="fa fa-paper-plane fa-4x text-primary mb-3 sr-icons" data-aos="zoom-in" data-aos-duration="200" data-aos-delay="200" data-aos-once="true"></i>
                        <h3 class="mb-3">Commercial</h3>
                        <p class="text-muted mb-0">Office</p>
                        <p class="text-muted mb-0">Industrial</p>
                        <p class="text-muted mb-0">Logistics</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 text-center">
                    <div class="mx-auto service-box mt-5"><i class="fa fa-newspaper-o fa-4x text-primary mb-3 sr-icons" data-aos="zoom-in" data-aos-duration="200" data-aos-delay="400" data-aos-once="true"></i>
                        <h3 class="mb-3">Land</h3>
                        <p class="text-muted mb-0">Property without building</p>
                        <p class="text-muted mb-0">Farm</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 text-center">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 text-center mx-auto">
                    ...
                    <hr class="my-4">
                    <p class="mb-5">Are you looking for a house or stand?</p>
                </div>
            </div>
            <div class="row">
