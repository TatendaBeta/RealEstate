                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="banner-main-home">                                
                                    <div class="banner-main-home-text">
                                        ...
                                        <div class="desc">
                                            <p>Real Estate Management allows you to find your home with less effort which is within your budget <a rel="nofollow" href="http://facebook.com" target="_parent">Facebook</a> Our Facebook Page</p>
                        ...
                        <div class="row margin-b-30">
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="box london">
                                    <div class="box-icon">
                                        <img src="{{url('assets/img/pic.jpg')}}" alt="Image" width="100px" height="250px">
                                    </div>
                                    <div class="info float-container">
                                        ...
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum, alias? </p><hr />
                                        <div class="col-sm-12 location-main"> 
                                            <div class="pull-left location">
                                                <i class="fa fa-map-marker fa-2x"></i><span>HARARE</span>
                                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="box paris">
                                    <div class="box-icon">
                                        <img src="{{url('assets/img/hec.jpg')}}" alt="Image"  width="100px" height="250px">
                                    </div>
                                    <div class="info float-container">
                                        ...
                                        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sed, nisi? </p><hr />
                                        <div class="col-sm-12 location-main"> 
                                    ...
                                    @foreach ($property as $item)
                                            ...
                                            <div class="col-xxs-12 col-xs-6 col-sm-6 col-md-4 col-lg-4">
                                                <div class="bottom-img">
                                                   <a href="{{url()}}"><img src="{{ asset('uploads/property/' . $item->images) }}" alt="Image" width="50px" height="175px"></a>
                                                    <p class="first">{{ $item->location }} ${{ $item->price }}</p>    
                                                </div>                                    
                                            <br>                                  
                                            </div>
                                     ...
                                     @endforeach
                                        ...
                                        <p class="bottom-desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto facilis veritatis dignissimos? Praesentium asperiores placeat illum ex eaque perferendis quasi? </p><hr />
                                        <div class="col-sm-12 location-main"> 
