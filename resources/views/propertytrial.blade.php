 ...
 <div class="container">    
  ...
  <h3 align="center">Insert Image into Mysql Database in Laravel 6</h3>
    ...
    <div class="panel panel-default">
         ...
         <br />
         <form method="post" action="{{ url('property/insert_image') }}"  enctype="multipart/form-data">
          @csrf
         ...
         <div class="form-group" align="center">
          <br />
          <br />
          <input type="submit" name="property" class="btn btn-primary" value="Save" />
         </div>
         </form>
      </div>
     </div>
     <div class="panel panel-default">
         ...
         <div class="table-responsive">
                <table class="table table-bordered table-striped">
                  ...
                  <tr>
                   <td>
                    <img src="property/fetch_image/{{ $row->id }}"  class="img-thumbnail" width="75" />
                   </td>
                   <td>{{ $row->user_name }}</td>
                  </tr>
                  @endforeach
